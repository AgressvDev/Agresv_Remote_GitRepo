...
class CircularImageCell3: UITableViewCell {
...
class OppOneViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
...
//        var mergedArray: [(username: String, imageData: String)] = []
    ...
    var mergedArray: [(username: String, imageData: String, username_plus_skill: String)] = []
        ...
        override func viewDidLoad() {
            ...
            // Register the custom cell class
                tableView.register(CircularImageCell3.self, forCellReuseIdentifier: "CircularImageCell3")
    ...
    private func setupLabel() {
        ...
        PlayerSearch_label.text = "Select Opponent 1"
    ...
    func fetchAgressvUsers(completion: @escaping () -> Void) {
        ...
        db.collection("Agressv_Users").getDocuments { (querySnapshot, error) in
            ...
            if !self.Selected_Partner.isEmpty {  // Check if it's not empty
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        GetEmail(usernameselection: selectedUsername)

        // Create an instance of PlayerProfileViewController
        if let OppOneVC = storyboard?.instantiateViewController(withIdentifier: "OppTwoID") as? OppTwoViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "CircularImageCell3", for: indexPath) as? CircularImageCell3 else {
    ...
    func setCornerRadiusForVisibleCells() {
        if let visibleIndexPaths = tableView.indexPathsForVisibleRows {
            for indexPath in visibleIndexPaths {
                if let cell = tableView.cellForRow(at: indexPath) as? CircularImageCell3 {
