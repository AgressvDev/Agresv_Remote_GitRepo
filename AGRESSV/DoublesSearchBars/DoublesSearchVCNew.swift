...
class CircularImageCell2: UITableViewCell {
...
class DoublesSearchVCNew: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
...
//        var mergedArray: [(username: String, imageData: String)] = []
    ...
    var mergedArray: [(username: String, imageData: String, username_plus_skill: String)] = []
        ...
        override func viewDidLoad() {
            ...
            // Register the custom cell class
                tableView.register(CircularImageCell2.self, forCellReuseIdentifier: "CircularImageCell2")
    ...
    private func setupLabel() {
        ...
        PlayerSearch_label.text = "Select Your Partner"
...
// 
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        SharedData.shared.PartnerSelection = selectedUsername
        GetEmail(usernameselection: selectedUsername)
        

        // Create an instance of PlayerProfileViewController
        if let OppOneVC = storyboard?.instantiateViewController(withIdentifier: "OppOneID") as? OppOneViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "CircularImageCell2", for: indexPath) as? CircularImageCell2 else {
    ...
    func setCornerRadiusForVisibleCells() {
        if let visibleIndexPaths = tableView.indexPathsForVisibleRows {
            for indexPath in visibleIndexPaths {
                if let cell = tableView.cellForRow(at: indexPath) as? CircularImageCell2 {
